...
function test_multiple_loops() {
    let test_inputs = [1, 2, 3];
    let i = 0;
    while ((i < test_inputs.length)) {
        let n = test_inputs[i];
        console.log(("First loop: " + String(n)));
        i = (i + 1);
    }
    i = 0;
    while ((i < test_inputs.length)) {
        n = test_inputs[i];
        console.log(("Second loop: " + String(n)));
        i = (i + 1);
    }
}
test_multiple_loops();
...
//# sourceMappingURL=test_multiple_loops.js.map