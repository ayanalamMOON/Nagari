...
impl BuiltinMapper {
    ...
    fn init_mappings(&mut self) {
        // Type constructors
        self.add_mapping("str", BuiltinMapping {
        ...
        self.add_mapping("int", BuiltinMapping {
        ...
        self.add_mapping("float", BuiltinMapping {
        ...
        self.add_mapping("bool", BuiltinMapping {
        ...
        self.add_mapping("list", BuiltinMapping {
        ...
        // Built-in functions
        self.add_mapping("print", BuiltinMapping {
        ...
        self.add_mapping("len", BuiltinMapping {
        ...
        self.add_mapping("range", BuiltinMapping {
        ...
        self.add_mapping("enumerate", BuiltinMapping {
        ...
        self.add_mapping("zip", BuiltinMapping {
        ...
        self.add_mapping("sum", BuiltinMapping {
        ...
        // Math functions
        self.add_mapping("abs", BuiltinMapping {
        ...
        self.add_mapping("max", BuiltinMapping {
        ...
        self.add_mapping("min", BuiltinMapping {
        ...
        self.add_mapping("round", BuiltinMapping {
        ...
        // Array methods
        self.add_mapping("append", BuiltinMapping {
        ...
        self.add_mapping("extend", BuiltinMapping {
            js_equivalent: ".push(...".to_string(),
            requires_import: None,
            requires_helper: false,
            is_method: true,
        ...
        self.add_mapping("insert", BuiltinMapping {
        ...
        self.add_mapping("pop", BuiltinMapping {
        ...
        self.add_mapping("remove", BuiltinMapping {
            js_equivalent: ".splice".to_string(),
            requires_import: None,
            requires_helper: false,
            is_method: true,
        ...
        self.add_mapping("index", BuiltinMapping {
        ...
        self.add_mapping("count", BuiltinMapping {
        ...
        self.add_mapping("sort", BuiltinMapping {
        ...
        self.add_mapping("reverse", BuiltinMapping {
        ...
        // String methods
        self.add_mapping("split", BuiltinMapping {
        ...
        self.add_mapping("join", BuiltinMapping {
        ...
        self.add_mapping("strip", BuiltinMapping {
        ...
        self.add_mapping("lower", BuiltinMapping {
        ...
        self.add_mapping("upper", BuiltinMapping {
        ...
        self.add_mapping("replace", BuiltinMapping {
        ...
        self.add_mapping("startswith", BuiltinMapping {
        ...
        self.add_mapping("endswith", BuiltinMapping {
        ...
        // Dict methods
        self.add_mapping("keys", BuiltinMapping {
        ...
        self.add_mapping("values", BuiltinMapping {
        ...
        self.add_mapping("items", BuiltinMapping {
        ...
        // Type checking
        self.add_mapping("isinstance", BuiltinMapping {
        ...
        self.add_mapping("hasattr", BuiltinMapping {
        ...
        // Iteration
        self.add_mapping("any", BuiltinMapping {
        ...
        self.add_mapping("all", BuiltinMapping {
        ...
        self.add_mapping("map", BuiltinMapping {
        ...
        self.add_mapping("filter", BuiltinMapping {
            js_equivalent: ".filter".to_string(),
            requires_import: None,
            requires_helper: false,
            is_method: true,
        ...
        self.add_mapping("reduce", BuiltinMapping {
