...
let text = "hello world from nagari";
...
let name_header = str_center("Name", 15);
let score_header = str_center("Score", 10);
let grade_header = str_center("Grade", 8);
console.log(((name_header + score_header) + grade_header));
console.log(("-" * 33));
let name1 = str_pad_right("Alice", 15);
let score1 = str_center("95", 10);
let grade1 = str_center("A", 8);
console.log(((name1 + score1) + grade1));
let name2 = str_pad_right("Bob", 15);
let score2 = str_center("87", 10);
let grade2 = str_center("B", 8);
